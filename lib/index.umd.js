(function (global, factory) {
  ...
  (global = global || self, global.QrCodeWithLogo = factory(global.QRCode));
  ...
  var renderQrCode = function renderQrCode(_ref) {
    var canvas = _ref.canvas,
        ...
        nodeQrCodeOptions = _ref$nodeQrCodeOption === void 0 ? {} : _ref$nodeQrCodeOption;
  ...
  var drawLogo = function drawLogo(_ref) {
    ...
    var _logo$logoSize = logo.logoSize,
        logoSize = _logo$logoSize === void 0 ? 0.15 : _logo$logoSize,
        borderColor = logo.borderColor,
        _logo$bgColor = logo.bgColor,
        bgColor = _logo$bgColor === void 0 ? borderColor || '#ffffff' : _logo$bgColor,
        _logo$borderSize = logo.borderSize,
        borderSize = _logo$borderSize === void 0 ? 0.05 : _logo$borderSize,
        crossOrigin = logo.crossOrigin,
        _logo$borderRadius = logo.borderRadius,
        borderRadius = _logo$borderRadius === void 0 ? 8 : _logo$borderRadius,
        _logo$logoRadius = logo.logoRadius,
        logoRadius = _logo$logoRadius === void 0 ? 0 : _logo$logoRadius;
    ...
    var ctx = canvas.getContext('2d'); // logo 底色
    ...
    image.src = logoSrc; // 使用image绘制可以避免某些跨域情况
  ...
  var toImage = function toImage(options) {
    ...
    return toCanvas$1(options).then(function () {
      var _options$image = options.image,
          image = _options$image === void 0 ? new Image() : _options$image,
          _options$downloadName = options.downloadName,
          downloadName = _options$downloadName === void 0 ? 'qr-code' : _options$downloadName;
